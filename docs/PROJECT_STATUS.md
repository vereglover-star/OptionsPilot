...
(**2493 tests**), ruff, HTML-id and doc checks, API contract check, pip check,
...
against its real API with a real key — all 2493 tests run against canned
...
from 2,247 to 2,414 (the suite is **2493 tests** today, after the release
...
**2493 tests, 100% passing** (`.\scripts\test.ps1`, ~95s).
