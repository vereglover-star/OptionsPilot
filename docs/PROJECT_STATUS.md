...
(**2836 tests**), ruff, HTML-id, **design-token** and **motion** checks, doc
...
against its real API with a real key — all 2836 tests run against canned
...
from 2,247 to 2,414 (the suite is **2836 tests** today, after the release
...
**2836 tests, 100% passing** (`.\scripts\test.ps1`, ~95s).
