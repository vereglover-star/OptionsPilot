...
(**2552 tests**), ruff, HTML-id and doc checks, API contract check, pip check,
...
against its real API with a real key — all 2552 tests run against canned
...
`0.9.2` — single source of truth: `optionspilot/__init__.py::__version__`
...
from 2,247 to 2,414 (the suite is **2552 tests** today, after the release
...
**2552 tests, 100% passing** (`.\scripts\test.ps1`, ~95s).
