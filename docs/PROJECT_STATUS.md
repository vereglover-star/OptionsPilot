...
(**2787 tests**), ruff, HTML-id, **design-token** and **motion** checks, doc
...
against its real API with a real key — all 2787 tests run against canned
...
from 2,247 to 2,414 (the suite is **2787 tests** today, after the release
...
**2787 tests, 100% passing** (`.\scripts\test.ps1`, ~95s).
