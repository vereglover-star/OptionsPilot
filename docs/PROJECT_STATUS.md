...
against its real API with a real key — all 2323 tests run against canned
...
and C3 (`MarketDataAdminService`) are landed; C4 (`TradingService`) is next.** The per-commit
...
**2323 tests, 100% passing** (`.\scripts\test.ps1`, ~95s).
