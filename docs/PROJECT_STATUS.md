...
against its real API with a real key — all 2849 tests run against canned
...
`0.14.0` — single source of truth: `optionspilot/__init__.py::__version__`
...
from 2,247 to 2,414 (the suite is **2849 tests** today, after the release
...
**2849 tests, 100% passing** (`.\scripts\test.ps1`, ~95s).
