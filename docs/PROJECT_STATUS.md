...
against its real API with a real key — all 2564 tests run against canned
...
from 2,247 to 2,414 (the suite is **2564 tests** today, after the release
...
**2564 tests, 100% passing** (`.\scripts\test.ps1`, ~95s).
