...
(**2592 tests**), ruff, HTML-id, **design-token** and **motion** checks, doc
...
against its real API with a real key — all 2592 tests run against canned
...
`0.11.0` — single source of truth: `optionspilot/__init__.py::__version__`
...
from 2,247 to 2,414 (the suite is **2592 tests** today, after the release
...
**2592 tests, 100% passing** (`.\scripts\test.ps1`, ~95s).
