...
2056 -> **2087 tests** (+9). **Not committed.** No feature, no dependency, no
...
1908 -> **2087 tests** (+140); a new **21-check** headless-browser suite
...
**Verified:** 2087 tests, 21/21 `workspace_check`, 135/135 `guide_check`, 54/54
