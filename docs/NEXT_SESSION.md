...
2056 -> **2094 tests** (+9). **Not committed.** No feature, no dependency, no
...
1908 -> **2094 tests** (+140); a new **21-check** headless-browser suite
...
**Verified:** 2094 tests, 21/21 `workspace_check`, 135/135 `guide_check`, 54/54
